...
userSchema.pre('save', function (next) {
  // When you create a new document to properties to tab bhi change hoti hai isliye condition dali this.isNew
...
// Since password me select: false hence this.password in not avaialable
